...
// Package bind generates Eutherum contract Go bindings.
//
// Detailed usage document and tutorial available on the eutherum Wiki page:
// https://github.com/eutherum/eutherum/wiki/Native-DApps:-Go-bindings-to-Eutherum-contracts
package bind
