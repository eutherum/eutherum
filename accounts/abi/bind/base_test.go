...
func (mc *mockCaller) CallContract(ctx context.Context, call eutherum.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (mc *mockCaller) PendingCallContract(ctx context.Context, call eutherum.CallMsg) ([]byte, error) {
