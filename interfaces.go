...
// Package eutherum defines interfaces for interacting with Eutherum.
package eutherum
...
type CallMsg struct {
	...
	GasPrice *big.Int        // uwei <-> gas exchange ratio
	Value    *big.Int        // amount of uwei sent along with the call
...
// GasPricer wraps the gas price euracle, which monitors the blockchain to determine the
