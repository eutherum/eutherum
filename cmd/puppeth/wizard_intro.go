...
// setting up a new or managing an existing Eutherum private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your Eutherum private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Eutherum network down to  |")
	...
	log.Info("Administering Eutherum network", "name", w.network)
