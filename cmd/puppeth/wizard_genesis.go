...
// importGenesis imports a Geuth genesis spec into puppeth.
...
func (w *wizard) manageGenesis() {
	...
	case "2":
		...
		// Export the native genesis spec used by puppeth and Geuth
		...
		// Export the genesis spec used by Aleth (formerly C++ Eutherum)
		...
		// Export the genesis spec used by Harmony (formerly EutherumJ)
