...
type wizard struct {
	...
	services map[string][]string   // Eutherum services known to be running on servers
...
// converts it to an Eutherum address. If an empty line is entered, the default
// value is returned.
