...
import (
	...
	"github.com/eutherum/eutherum/internal/utesting"
...
func TestEthSuite(t *testing.T) {
	geuth, err := runGeth()
	if err != nil {
		t.Fatalf("could not run geuth: %v", err)
	}
	defer geuth.Close()

	suite, err := NewSuite(geuth.Server().Self(), fullchainFile, genesisFile)
	if err != nil {
...
// runGeth creates and starts a geuth node
