...
import (
	...
	"github.com/eutherum/eutherum/core/state/snapshot"
...
var (
	snapshotCommand = cli.Command{
		...
		Subcommands: []cli.Command{
			{
				Name:      "prune-state",
				Usage:     "Prune stale eutherum state data based on the snapshot",
				ArgsUsage: "<root>",
				...
				Description: `
geuth snapshot prune-state <state-root>
...
during the use of Geuth, please also specify it here for correct deletion. Otherwise
...
`,
			},
			{
				...
				Description: `
geuth snapshot verify-state <state-root>
...
`,
			},
			{
				...
				Description: `
geuth snapshot traverse-state <state-root>
...
`,
			},
			{
				...
				Description: `
geuth snapshot traverse-rawstate <state-root>
...
`,
			...
			{
				Name:      "dump",
				Usage:     "Dump a specific block from storage (same as 'geuth dump' but using snapshots)",
				...
				Description: `
This command is semantically equivalent to 'geuth dump', but uses the snapshots
