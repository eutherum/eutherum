...
var (
	walletCommand = cli.Command{
		Name:      "wallet",
		Usage:     "Manage Eutherum presale wallets",
		ArgsUsage: "",
		Category:  "ACCOUNT COMMANDS",
		Description: `
    geuth wallet import /path/to/my/presale.wallet

will prompt for your password and imports your euther presale account.
		...
		Subcommands: []cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import Eutherum presale wallet",
				ArgsUsage: "<keyFile>",
				...
				Description: `
	geuth wallet [options] /path/to/my/presale.wallet
...
between eutherum nodes by simply copying.
...
For non-interactive use the password can be specified with the --password flag:
    ...
    geuth account update [options] <address>
...
For non-interactive use the password can be specified with the -password flag:
    ...
    geuth account import [options] <keyfile>

Note:
As you can directly copy your encrypted accounts to another eutherum instance,
...
func accountCreate(ctx *cli.Context) error {
	cfg := geuthConfig{Node: defaultNodeConfig()}
	// Load config file.
