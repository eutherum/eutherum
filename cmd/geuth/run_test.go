...
import (
	...
	"github.com/eutherum/eutherum/internal/cmdtest"
	"github.com/eutherum/eutherum/rpc"
)

func tmpdir(t *testing.T) string {
	dir, err := ioutil.TempDir("", "geuth-test")
	if err != nil {
		t.Fatal(err)
	}
	return dir
...
func init() {
	// Run the app if we've been exec'd as "geuth-test" in runGeuth.
	reexec.Register("geuth-test", func() {
...
// spawns geuth with the given command line args. If the args don't set --datadir, the
// child g gets a temporary data directory.
func runGeuth(t *testing.T, args ...string) *testgeuth {
	tt := &testgeuth{}
	...
	// Boot "geuth". This actually runs the test binary but the TestMain
	// function will prevent any tests from running.
	tt.Run("geuth-test", args...)
