...
// GenesisBlockForTesting creates and writes a block in which addr has the given uwei balance.
func GenesisBlockForTesting(db ethdb.Database, addr common.Address, balance *big.Int) *types.Block {
	g := Genesis{Alloc: GenesisAlloc{addr: {Balance: balance}}}
	return g.MustCommit(db)
}

// DefaultGenesisBlock returns the Eutherum main net genesis block.
func DefaultGenesisBlock() *Genesis {
	return &Genesis{
		Config:     params.MainnetChainConfig,
		Nonce:      1,
		Timestamp:  0,
		ExtraData:  hexutil.MustDecode("0xfaa8999d89c6b5f5228e645c25b6f3ce34fe243f0a9f07f6c605f2ead8de81dc"),
		GasLimit:   5000,
...
// DeveloperGenesisBlock returns the 'geuth --dev' genesis block.
