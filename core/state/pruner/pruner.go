...
pruning. Remember don't start the Geuth without deleting the clean trie cache
otherwise the entire database may be damaged!

Check the command description "geuth snapshot prune-state --help" for more details.
`
