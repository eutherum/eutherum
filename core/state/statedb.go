...
// Package state provides a caching layer atop the Eutherum state trie.
package state
...
// StateDB structs within the eutherum protocol are used to store anything
...
//
// Carrying over the balance ensures that Euther doesn't disappear.
...
func (s *StateDB) Copy() *StateDB {
	...
	for addr := range s.journal.dirties {
		// As documented [here](https://github.com/eutherum/eutherum/pull/16485#issuecomment-380438527),
