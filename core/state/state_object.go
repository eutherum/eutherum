...
// stateObject represents an Eutherum account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of eutherum address of the account
	data     Account
	db       *StateDB
...
// Account is the Eutherum consensus representation of accounts.
