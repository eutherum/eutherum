...
// Package types contains data types related to Eutherum consensus.
package types
...
// Header represents a block header in the Eutherum blockchain.
type Header struct {
...
// Block represents an entire block in the Eutherum blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// DecodeRLP decodes the Eutherum
...
// EncodeRLP serializes b into the Eutherum RLP block format.
