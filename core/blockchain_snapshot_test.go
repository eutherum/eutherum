...
// It can be used for testing that restart Geuth normally.
...
// It can be used for testing that restart Geuth after the crash.
...
// Tests a Geuth restart with valid snapshot. Before the shutdown, all snapshot
...
// Tests a Geuth was crashed and restarts with a broken snapshot. In this case the
...
// Tests a Geuth was crashed and restarts with a broken snapshot. In this case
...
// Tests a Geuth was running with snapshot enabled. Then restarts without
...
// Tests the Geuth was running with snapshot enabled and resetHead is applied.
...
// Tests the Geuth was running with a complete snapshot and then imports a few
