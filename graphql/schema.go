...
const schema string = `
    ...
    scalar Bytes32
    # Address is a 20 byte Eutherum address, represented as 0x-prefixed hexadecimal.
    scalar Address
    ...
    # Account is an Eutherum account at a particular block.
    type Account {
    ...
    # Transaction is an Eutherum transaction.
    type Transaction {
    ...
    type Block {
        ...
        # Account fetches an Eutherum account at the current block's state.
    ...
    type Pending {
      ...
      transactions: [Transaction!]
      # Account fetches an Eutherum account for the pending state.
      account(address: Address!): Account!
    ...
    type Query {
        # Block fetches an Eutherum block by number or by hash. If neither is
