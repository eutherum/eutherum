...
// Package graphql provides a GraphQL interface to Eutherum node data.
package graphql
...
// Account represents an Eutherum account at a particular block.
type Account struct {
...
// Transaction represents an Eutherum transaction.
...
// Block represents an Eutherum block.
...
type CallData struct {
	From     *common.Address // The Eutherum address the call is from.
	To       *common.Address // The Eutherum address the call is to.
...
type SyncState struct {
	progress eutherum.SyncProgress
}
