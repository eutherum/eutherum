...
/**
 * @title CheckpointEuracle
 * @author Gary Rong<garyrong@eutherum.org>, Martin Swende <martin.swende@eutherum.org>
 * @dev Implementation of the blockchain checkpoint registrar.
 */
contract CheckpointEuracle {
    /*
        Events
    */
    ...
    */
    ...
    //
    // The default value should be the same as the checkpoint size(32768) in the eutherum.
    uint sectionSize;
