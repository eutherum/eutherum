...
// Syncing provides information when this nodes starts synchronising with the Eutherum network and when it's finished.
...
type SyncingResult struct {
	...
	Status  eutherum.SyncProgress `json:"status"`
}
