...
import (
	...
	chainParams "github.com/eutherum/eutherum/params"
	"github.com/eutherum/eutherum/rpc"
	"github.com/eutherum/eutherum/trie"
)

// Register adds catalyst APIs to the node.
func Register(stack *node.Node, backend *eth.Eutherum) error {
...
func newConsensusAPI(eth *eth.Eutherum) *consensusAPI {
