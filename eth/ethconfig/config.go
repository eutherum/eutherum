...
// Package ethconfig contains the configuration of the UTH and LES protocols.
package ethconfig
...
// Defaults contains default settings for use on the Eutherum main net.
var Defaults = Config{
...
// Config contains configuration options for of the UTH and LES protocols.
type Config struct {
	// The genesis block, which is inserted if the database is empty.
	// If nil, the Eutherum main net block is used.
