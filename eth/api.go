...
import (
	...
	"github.com/eutherum/eutherum/trie"
)

// PublicEutherumAPI provides an API to access Eutherum full node-related
// information.
type PublicEutherumAPI struct {
	e *Eutherum
}

// NewPublicEutherumAPI creates a new Eutherum protocol API for full nodes.
func NewPublicEutherumAPI(e *Eutherum) *PublicEutherumAPI {
	return &PublicEutherumAPI{e}
}

// Etherbase is the address that mining rewards will be send to
func (api *PublicEutherumAPI) Etherbase() (common.Address, error) {
	return api.e.Etherbase()
}

// Coinbase is the address that mining rewards will be send to (alias for Etherbase)
func (api *PublicEutherumAPI) Coinbase() (common.Address, error) {
	return api.Etherbase()
}

// Hashrate returns the POW hashrate
func (api *PublicEutherumAPI) Hashrate() hexutil.Uint64 {
...
func NewPublicMinerAPI(e *Eutherum) *PublicMinerAPI {
...
func NewPrivateMinerAPI(e *Eutherum) *PrivateMinerAPI {
...
// PrivateAdminAPI is the collection of Eutherum full node-related APIs
...
// admin methods of the Eutherum service.
func NewPrivateAdminAPI(eth *Eutherum) *PrivateAdminAPI {
...
// PublicDebugAPI is the collection of Eutherum full node APIs exposed
...
// related public debug methods of the Eutherum service.
func NewPublicDebugAPI(eth *Eutherum) *PublicDebugAPI {
...
// PrivateDebugAPI is the collection of Eutherum full node APIs exposed over
...
// private debug methods of the Eutherum service.
func NewPrivateDebugAPI(eth *Eutherum) *PrivateDebugAPI {
