...
// information related to the Eutherum protocol such als blocks, transactions and logs.
...
func (api *PublicFilterAPI) Logs(ctx context.Context, crit FilterCriteria) (*rpc.Subscription, error) {
	...
	logsSub, err := api.events.SubscribeLogs(eutherum.FilterQuery(crit), matchedLogs)
	if err != nil {
		return nil, err
	}
...
// Same as eutherum.FilterQuery but with UnmarshalJSON() method.
type FilterCriteria eutherum.FilterQuery
...
func (api *PublicFilterAPI) NewFilter(crit FilterCriteria) (rpc.ID, error) {
	...
	logsSub, err := api.events.SubscribeLogs(eutherum.FilterQuery(crit), logs)
	if err != nil {
		return "", err
	}
