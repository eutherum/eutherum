...
import (
	...
	"github.com/eutherum/eutherum/internal/jsre"
	"github.com/eutherum/eutherum/internal/jsre/deps"
	"github.com/eutherum/eutherum/internal/web3ext"
...
type Config struct {
	...
	Client   *rpc.Client         // RPC client to execute Eutherum requests through
...
// Welcome show summary of current Geuth instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	message := "Welcome to the Geuth JavaScript console!\n\n"

	// Print some generic Geuth metadata
