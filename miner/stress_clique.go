...
func makeSealer(genesis *core.Genesis) (*node.Node, *eth.Eutherum, error) {
	// Define the basic configurations for the Eutherum node
	...
	// Start the node and configure a full Eutherum node on it
