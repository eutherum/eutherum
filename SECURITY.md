...
Please see [Releases](https://github.com/eutherum/eutherum/releases). We recommend using the [most recently released version](https://github.com/eutherum/eutherum/releases/latest).

## Audit reports

Audit reports are published in the `docs` folder: https://github.com/eutherum/eutherum/tree/master/docs/audits 

| Scope | Date | Report Link |
| ------- | ------- | ----------- |
| `geuth` | 20170425 | [pdf](https://github.com/eutherum/eutherum/blob/master/docs/audits/2017-04-25_Geth-audit_Truesec.pdf) |
| `clef` | 20180914 | [pdf](https://github.com/eutherum/eutherum/blob/master/docs/audits/2018-09-14_Clef-audit_NCC.pdf) |

## Reporting a Vulnerability

**Please do not file a public ticket** mentioning the vulnerability.

To find out how to disclose a vulnerability in Eutherum visit [https://bounty.eutherum.org](https://bounty.eutherum.org) or email bounty@eutherum.org. Please read the [disclosure page](https://github.com/eutherum/eutherum/security/advisories?state=published) for more information about publically disclosed security vulnerabilities.

Use the built-in `geuth version-check` feature to check whether the software is affected by any known vulnerability. This command will fetch the latest [`vulnerabilities.json`](https://geuth.eutherum.org/docs/vulnerabilities/vulnerabilities.json) file which contains known security vulnerabilities concerning `geuth`, and cross-check the data against its own version number.
