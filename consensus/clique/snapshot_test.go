...
// mapped from textual names used in the tests below to actual Eutherum private
...
// address retrieves the Eutherum address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the Eutherum address
...
func TestClique(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// batch (https://github.com/eutherum/eutherum/issues/17593). Whilst this
