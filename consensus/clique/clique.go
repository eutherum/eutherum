...
// ecrecover extracts the Eutherum account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the Eutherum address
...
// Eutherum testnet following the Ropsten attacks.
type Clique struct {
	...
	signer common.Address // Eutherum address of the signing key
...
// Author implements consensus.Engine, returning the Eutherum address recovered
