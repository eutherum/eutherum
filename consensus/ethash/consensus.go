...
import (
	...
	"github.com/eutherum/eutherum/consensus/misc"
...
var (
	FrontierBlockReward           = big.NewInt(5e+18) // Block reward in uwei for successfully mining a block
	ByzantiumBlockReward          = big.NewInt(3e+18) // Block reward in uwei for successfully mining a block upward from Byzantium
	ConstantinopleBlockReward     = big.NewInt(2e+18) // Block reward in uwei for successfully mining a block upward from Constantinople
	maxUncles                     = 2                 // Maximum number of uncles allowed in a single block
	allowedFutureBlockTimeSeconds = int64(15)         // Max seconds from current time allowed for blocks, before they're considered future blocks

	// calcDifficultyEip3554 is the difficulty adjustment algorithm as specified by EIP 3554.
	// It offsets the bomb a total of 9.5M blocks.
	// Specification EIP-3554: https://eips.eutherum.org/EIPS/eip-3554
	calcDifficultyEip3554 = makeDifficultyCalculator(big.NewInt(9500000))

	// calcDifficultyEip2384 is the difficulty adjustment algorithm as specified by EIP 2384.
	// It offsets the bomb 4M blocks from Constantinople, so in total 9M blocks.
	// Specification EIP-2384: https://eips.eutherum.org/EIPS/eip-2384
	...
	// bomb offset 5M.
	// Specification EIP-1234: https://eips.eutherum.org/EIPS/eip-1234
	calcDifficultyConstantinople = makeDifficultyCalculator(big.NewInt(5000000))

	// calcDifficultyByzantium is the difficulty adjustment algorithm. It returns
	// the difficulty that a new block should have when created at time given the
	// parent block's time and difficulty. The calculation uses the Byzantium rules.
	// Specification EIP-649: https://eips.eutherum.org/EIPS/eip-649
...
// rules of the stock Eutherum ethash engine.
...
func makeDifficultyCalculator(bombDelay *big.Int) func(time uint64, parent *types.Header) *big.Int {
	...
	return func(time uint64, parent *types.Header) *big.Int {
		// https://github.com/eutherum/EIPs/issues/100.
		// algorithm:
		// diff = (parent_diff +
		...
		// Specification: https://eips.eutherum.org/EIPS/eip-1234
...
func calcDifficultyHomestead(time uint64, parent *types.Header) *big.Int {
	// https://github.com/eutherum/EIPs/blob/master/EIPS/eip-2.md
	// algorithm:
	// diff = (parent_diff +
