...
import (
	...
	"github.com/eutherum/eutherum/p2p/simulations"
	"github.com/eutherum/eutherum/p2p/simulations/adapters"
...
func newLesServerService(ctx *adapters.ServiceContext, stack *node.Node) (node.Lifecycle, error) {
	...
	eutherum, err := eth.New(stack, &config)
	if err != nil {
		return nil, err
	}
	_, err = NewLesServer(stack, eutherum, &config)
	if err != nil {
		return nil, err
	}
	return eutherum, nil
