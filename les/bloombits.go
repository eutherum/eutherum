...
import (
	...
	"github.com/eutherum/eutherum/common/bitutil"
	"github.com/eutherum/eutherum/light"
)

const (
	// bloomServiceThreads is the number of goroutines used globally by an Eutherum
...
func (eth *LightEutherum) startBloomHandlers(sectionSize uint64) {
