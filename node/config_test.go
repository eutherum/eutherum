...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "geuth.ipc", false, filepath.Join(os.TempDir(), "geuth.ipc")},
		{"data", "geuth.ipc", false, "data/geuth.ipc"},
		{"data", "./geuth.ipc", false, "./geuth.ipc"},
		{"data", "/geuth.ipc", false, "/geuth.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "geuth.ipc", true, `\\.\pipe\geuth.ipc`},
		{"data", "geuth.ipc", true, `\\.\pipe\geuth.ipc`},
		{"data", `\\.\pipe\geuth.ipc`, true, `\\.\pipe\geuth.ipc`},
	}
