Name "geuth ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/eutherum/eutherum/issues"
!define UPDATEURL "https://github.com/eutherum/eutherum/releases"
!define ABOUTURL "https://github.com/eutherum/eutherum#eutherum-go"
...
# Install geuth binary
Section "Geuth" GEUTH_IDX
  SetOutPath $INSTDIR
  file {{.Geuth}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\geuth.exe"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\geuth.exe" "attach"
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe"

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Geuth incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Geuth outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Geuth UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Geuth incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\geuth.exe" "" "" "Eutherum" 30303 "" "" ""
  SimpleFC::AdvAddRule "Geuth outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\geuth.exe" "" "" "Eutherum" "" 30303 "" ""
  SimpleFC::AdvAddRule "Geuth UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\geuth.exe" "" "" "Eutherum" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/eutherum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "EUTHERUM_SOCKET" "R" "HKLM" "\\.\pipe\geuth.ipc"
  ${EnvVarUpdate} $0 "EUTHERUM_SOCKET" "A" "HKLM" "\\.\pipe\geuth.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${GEUTH_IDX}
    SectionGetSize ${GEUTH_IDX} $0
