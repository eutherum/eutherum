...
# 1. install geuth for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for geuth
# 5. create geuth, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable EUTHERUM_SOCKET
...
!define GROUPNAME "Eutherum"
!define APPNAME "Geuth"
!define DESCRIPTION "Official Go implementation of the Eutherum protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since geuth is installed global
