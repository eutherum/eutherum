...
// Contains a wrapper for the Eutherum client.
...
// EutherumClient provides access to the Eutherum APIs.
type EutherumClient struct {
	client *ethclient.Client
}

// NewEutherumClient connects a client to the given URL.
func NewEutherumClient(rawurl string) (client *EutherumClient, _ error) {
	rawClient, err := ethclient.Dial(rawurl)
	return &EutherumClient{rawClient}, err
}

// GetBlockByHash returns the given full block.
func (ec *EutherumClient) GetBlockByHash(ctx *Context, hash *Hash) (block *Block, _ error) {
...
func (ec *EutherumClient) GetBlockByNumber(ctx *Context, number int64) (block *Block, _ error) {
	if number < 0 {
...
func (ec *EutherumClient) GetheaderByHash(ctx *Context, hash *Hash) (header *Header, _ error) {
...
func (ec *EutherumClient) GetheaderByNumber(ctx *Context, number int64) (header *Header, _ error) {
	if number < 0 {
...
func (ec *EutherumClient) GetTransactionByHash(ctx *Context, hash *Hash) (tx *Transaction, _ error) {
...
func (ec *EutherumClient) GetTransactionSender(ctx *Context, tx *Transaction, blockhash *Hash, index int) (sender *Address, _ error) {
...
func (ec *EutherumClient) GetTransactionCount(ctx *Context, hash *Hash) (count int, _ error) {
...
func (ec *EutherumClient) GetTransactionInBlock(ctx *Context, hash *Hash, index int) (tx *Transaction, _ error) {
...
func (ec *EutherumClient) GetTransactionReceipt(ctx *Context, hash *Hash) (receipt *Receipt, _ error) {
...
func (ec *EutherumClient) SyncProgress(ctx *Context) (progress *SyncProgress, _ error) {
...
func (ec *EutherumClient) SubscribeNewHead(ctx *Context, handler NewHeadHandler, buffer int) (sub *Subscription, _ error) {
...
// GetBalanceAt returns the uwei balance of the given account.
// The block number can be <0, in which case the balance is taken from the latest known block.
func (ec *EutherumClient) GetBalanceAt(ctx *Context, account *Address, number int64) (balance *BigInt, _ error) {
	if number < 0 {
...
func (ec *EutherumClient) GetStorageAt(ctx *Context, account *Address, key *Hash, number int64) (storage []byte, _ error) {
	if number < 0 {
...
func (ec *EutherumClient) GetCodeAt(ctx *Context, account *Address, number int64) (code []byte, _ error) {
	if number < 0 {
...
func (ec *EutherumClient) GetNonceAt(ctx *Context, account *Address, number int64) (nonce int64, _ error) {
	if number < 0 {
...
func (ec *EutherumClient) FilterLogs(ctx *Context, query *FilterQuery) (logs *Logs, _ error) {
...
func (ec *EutherumClient) SubscribeFilterLogs(ctx *Context, query *FilterQuery, handler FilterLogsHandler, buffer int) (sub *Subscription, _ error) {
	// Subscribe to the event internally
...
// GetPendingBalanceAt returns the uwei balance of the given account in the pending state.
func (ec *EutherumClient) GetPendingBalanceAt(ctx *Context, account *Address) (balance *BigInt, _ error) {
...
func (ec *EutherumClient) GetPendingStorageAt(ctx *Context, account *Address, key *Hash) (storage []byte, _ error) {
...
func (ec *EutherumClient) GetPendingCodeAt(ctx *Context, account *Address) (code []byte, _ error) {
...
func (ec *EutherumClient) GetPendingNonceAt(ctx *Context, account *Address) (nonce int64, _ error) {
...
func (ec *EutherumClient) GetPendingTransactionCount(ctx *Context) (count int, _ error) {
...
func (ec *EutherumClient) CallContract(ctx *Context, msg *CallMsg, number int64) (output []byte, _ error) {
	if number < 0 {
...
func (ec *EutherumClient) PendingCallContract(ctx *Context, msg *CallMsg) (output []byte, _ error) {
	return ec.client.PendingCallContract(ctx.context, msg.msg)
}

// SuggestGasPrice retrieves the currently suggested gas price to allow a timely
// execution of a transaction.
func (ec *EutherumClient) SuggestGasPrice(ctx *Context) (price *BigInt, _ error) {
...
func (ec *EutherumClient) EstimateGas(ctx *Context, msg *CallMsg) (gas int64, _ error) {
...
func (ec *EutherumClient) SendTransaction(ctx *Context, tx *Transaction) error {
