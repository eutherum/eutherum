...
// Contains all the wrappers from the eutherum root package.
...
func (p *SyncProgress) GeuthighestBlock() int64 { return int64(p.progress.HighestBlock) }
